...
namespace DACS.Migrations
{
    ...
    [Migration("20240530133119_addchuandoandieutri")]
    partial class addchuandoandieutri
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebDatLichKham.Models.ChanDoan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MoTaChanDoan")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebDatLichKham.Models.DieuTri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ChanDoanId")
                        .HasColumnType("int");

                    b.Property<string>("MoTaDieuTri")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.HasIndex("ChanDoanId")
                        .IsUnique();
            ...
            modelBuilder.Entity("WebDatLichKham.Models.DieuTri", b =>
                {
                    b.HasOne("WebDatLichKham.Models.ChanDoan", "ChanDoan")
                        .WithOne("DieuTri")
                        .HasForeignKey("WebDatLichKham.Models.DieuTri", "ChanDoanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
